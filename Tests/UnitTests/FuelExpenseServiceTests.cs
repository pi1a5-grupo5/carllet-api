...
namespace Tests.UnitTests
{
    public class ExpenseControllerTests
    {
        ...
        {
            var fuelExpense = new FuelExpense { UserVehicleId = new Guid("be801137-fb11-41b6-b2f3-dfe88d59bd39"), Value = 50, ExpenseDate = new DateTime(), FuelExpenseTypeId = 1, Liters = 50 };
        ...
        {
            var fuelExpense = new FuelExpense { UserVehicleId = new Guid("be801137-fb11-41b6-b2f3-dfe88d59bd00"), Value = 50, ExpenseDate = new DateTime(), FuelExpenseTypeId = 1, Liters = 50 };
            Expense result = await _expenseService.RegisterExpense(fuelExpense);
